	...
	return react_1.default.createElement(
				...
				react_1.default.createElement(
					...
					react_1.default.createElement(
						...
						react_1.default.createElement(
							...
							react_1.default.createElement(
								"ul",
								{ role: "list", className: "flex flex-1 flex-col gap-y-7" },
								react_1.default.createElement(
									"li",
									null,
									react_1.default.createElement(
										"ul",
										{ role: "list", className: "-mx-2 space-y-1" },
										react_1.default.createElement(
											"li",
											null,
											react_1.default.createElement(
								...
								react_1.default.createElement(
									...
									react_1.default.createElement(
										"ul",
										{ role: "list", className: "-mx-2 mt-2 space-y-1" },
										react_1.default.createElement(
											"li",
											null,
											react_1.default.createElement(
												...
												react_1.default.createElement(
													...
													{
														className:
															"flex h-6 w-6 shrink-0 items-center justify-center rounded-lg border border-gray-700 bg-gray-800 text-[0.625rem] font-medium text-gray-400 group-hover:text-white",
													},
													"H",
												),
												react_1.default.createElement(
		...
		react_1.default.createElement(
			...
			react_1.default.createElement(
				...
				react_1.default.createElement(
					"button",
					{ type: "button", className: "-m-2.5 p-2.5 text-gray-700 lg:hidden" },
					react_1.default.createElement(
						"span",
						{ className: "sr-only" },
						"Open sidebar",
				...
				react_1.default.createElement(
					...
					react_1.default.createElement(
						"form",
						{ className: "relative flex flex-1", action: "#", method: "GET" },
						react_1.default.createElement(
							"label",
							{ for: "search-field", className: "sr-only" },
							"Search",
						),
						react_1.default.createElement(
							"svg",
